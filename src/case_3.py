...
model = BM_five_pool(B0=3, B1=2, Tsat=2, Td=6.5e-3, offset_b=-3, offset_c=3.5, 
...
df.to_excel(os.path.join(base_dir, "results", "case_3.xlsx"), header=False, index=False)
